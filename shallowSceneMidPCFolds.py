...
dfScenes=dfKnownOverlap['image_id_x']
...
dfPCA=pd.read_csv('gkPC_Lay9.csv',index_col=0)
#dfPCA=pd.read_csv('gkPC_LayTop.csv',index_col=0)

indList=dfPCA.index
#for str in indList
indListNew=[]
for str in indList:
  indListNew.append(int(str.split('.')[0]))
